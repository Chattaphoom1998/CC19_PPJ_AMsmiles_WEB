			...
			<div className="flex flex-1 justify-end items-center gap-4 ">
				...
				<div className="dropdown dropdown-end ">
					<div
						tabIndex={0}
						role="button"
						className="btn btn-ghost h-12 hover:bg-slate-200 hover:border-green-700 hover:border-2 rounded-lg hover:text-green-900"
					>
						<Avatar
					...
					<ul
						tabIndex={0}
						className="dropdown-content menu bg-slate-200 rounded-box z-[1] w-60 p-2 shadow text-green-950 rounded-lg"
					>
						<div>
							<Me />
						</div>
						<div className="divider my-1"></div>
						<li className="hover:bg-green-700 hover:text-slate-50 rounded-lg ">
							<Link to={`/${path}/${user.id}`}>Profile</Link>
						</li>

						<li
							className="hover:bg-slate-300 hover:border-red-500 hover:text-red-400 rounded-lg"
							onClick={logout}
						>
							<a>Logout</a>
						</li>
